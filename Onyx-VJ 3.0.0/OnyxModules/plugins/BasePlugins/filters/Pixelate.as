package filters {
	...
	public final class Pixelate extends Filter implements IBitmapFilter {
		...
		public function Pixelate():void {
			...
			super(false,
				new ControlInt('amount', 'amount', 2, 20, 4),
				new ControlNumber('alpha', 'alpha', 0, 1, 1),
				new ControlNumber('scale', 'scale', 0, 2, 1)
			)
		}
		...
		public function get amount():int {
			return BITMAP_WIDTH / _temp.width;
		}
		
		public function applyFilter(source:BitmapData):void {
			var matrix:Matrix = new Matrix();
			matrix.scale(_temp.width / BITMAP_WIDTH, _temp.height / BITMAP_HEIGHT);
