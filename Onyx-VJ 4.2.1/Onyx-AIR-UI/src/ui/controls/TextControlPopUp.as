...
package ui.controls {
	...
	public final class TextControlPopUp extends UIObject {
		 ...
		 * 	@private
		 */
		private var _input:ui.text.TextField;
		 ...
		 * 	@constructor
		 */
		public function TextControlPopUp(parent:DisplayObjectContainer, background:BitmapData, width:int, height:int, text:String, control:Parameter = null):void {
			...
			if (parent) {
				...
				_input				= Factory.getNewInstance(ui.text.TextField);
