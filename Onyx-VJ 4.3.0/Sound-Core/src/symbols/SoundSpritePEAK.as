...
package symbols {
	 ...
	 */
	public class SoundSpritePEAK extends SoundSprite implements ISoundPeak {
		...
		public function SoundSpritePEAK():void {
			...
			// add event listener
			PluginManager.modules[ID].LINEIN.addEventListener(SoundEvent.SOUND, onPeak);
		...
		override public function dispose():void {
			PluginManager.modules[ID].LINEIN.removeEventListener(SoundEvent.SOUND, onPeak);
		}
	}
}
