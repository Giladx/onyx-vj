 ...
 * Downloaded from: http://wonderfl.net/c/kUih
 */
...
package plugins.visualizer {
	...
	public final class PointLightVisualizer extends Visualizer {
		...
		public function PointLightVisualizer():void {
...
class JuliaSet extends Sprite {
	...
	public function JuliaSet() {
		...
		_width = DISPLAY_WIDTH / _scaleFactor;
		_height = DISPLAY_HEIGHT / _scaleFactor;
