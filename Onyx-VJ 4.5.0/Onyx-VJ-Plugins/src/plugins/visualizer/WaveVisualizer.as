...
package plugins.visualizer {
	...
	public final class WaveVisualizer extends Visualizer
	{
		...
		override public function render(info:RenderInfo):void 
		{
			...
			//Console.output('WaveParticle wave.tightness:'+arraytotal);
			wave.tightness = SpectrumAnalyzer.leftPeak + SpectrumAnalyzer.rightPeak;//arraytotal/3;
			wave.segments = arraytotal+1;
...
class Wave extends Sprite {
	...
	private var _segments:uint = 5;
	private var ratio:Number = 1/_segments;
	private var color:uint = 0xFFFFFF;
	private var perlin:PerlinNoise;
	private var t:Number = 0;
	private var c:uint = 0;
	private var _tightness:uint = 40;
	...
	{
		if ( value > 0 ) _segments = value;
	}

	public function get tightness():uint
	{
		return _tightness;
	}

	public function set tightness(value:uint):void
	{
		_tightness = value;
	}
