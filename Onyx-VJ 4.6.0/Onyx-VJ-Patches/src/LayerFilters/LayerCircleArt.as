...
package LayerFilters 
{
	...
	public class LayerCircleArt extends Patch 
	{
		...
		private var _totalDecay:int = 300;
		...
		{
			Console.output('LayerCircleArt 4.0.503');
			...
			parameters.addParameters(
				...
				new ParameterInteger( 'totalDecay', 'totalDecay', 1, 300, 35 )
			);
			spread = _spread;
			totalDecay = _totalDecay;
		...
		public function get totalDecay():int
		{
			return _totalDecay;
		}

		public function set totalDecay(value:int):void
		{
			_totalDecay = value;
		}
