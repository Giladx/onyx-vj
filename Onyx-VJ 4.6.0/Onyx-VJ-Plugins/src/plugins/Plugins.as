	...
	final public class Plugins extends PluginLoader {
		...
		public function Plugins():void {
			...
			addPlugins(
				...
				new Plugin('HalftoneFilter', 		HalftoneFilter,		'Halftone Filter'),	
				new Plugin('Rotate', 				Rotate,				'Rotate'),	
				new Plugin('BadReception', 			BadReception,		'Bad Reception'),	
				new Plugin('GLFilter', 				GLFilter,			'GLFilter'),	
				new Plugin('AutoXFade', 			AutoXFade,			'Auto XFade'),	
				new Plugin('CenterKaleidoscope', 	CenterKaleidoscope,	'Center Kaleidoscope', new AssetKaleid().bitmapData),
				new Plugin('KugatFilter', 			KugatFilter,		'Kugat Filter'),
				new Plugin('SpiralCut', 			SpiralCut,			'Spiral Cut'),
				...
				new Plugin('Square Filter',			SquareFilter,		'Square Filter'),
				...
				new Plugin('Gravity', 				GravityVisualizer, 			'Gravity'), 
				new Plugin('Lines3D', 				Lines3DVisualizer, 			'Lines3D'), 
				new Plugin('LinesCircle', 			LineVisualizer, 			'LinesCircle'), 
				new Plugin('MusicAtom', 			MusicAtomVisualizer, 		'MusicAtom'), 
				...
				new Plugin('BeatDrawingVisualizer', BeatDrawingVisualizer, 		'Beat Drawing'),
				new Plugin('ClassicVisualizer',		ClassicVisualizer, 			'Classic'),
