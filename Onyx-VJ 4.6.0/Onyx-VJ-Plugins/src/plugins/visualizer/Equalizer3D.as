/**
 * Copyright y.fukuo0928 ( http://wonderfl.net/user/y.fukuo0928 )
 * MIT License ( http://www.opensource.org/licenses/mit-license.php )
 * Downloaded from: http://wonderfl.net/c/4l05
 */

// forked from kamipoo's Equalizer3D
/**
 * 3Dã®ã‚¤ã‚³ãƒ©ã‚¤ã‚¶ãƒ¼ã€‚
 * Zã‚½ãƒ¼ãƒˆã ã¨ãƒãƒªã‚´ãƒ³æ¬ ã‘ãŒç›®ç«‹ã£ãŸã®ã§ã€ã‚¤ãƒ³ãƒ‡ãƒƒã‚¯ã‚¹ã‚½ãƒ¼ãƒˆã«å¤‰æ›´ã€‚
 * ã‚«ãƒ¡ãƒ©ã¨ã®è·é›¢ã§æ¯Žãƒ•ãƒ¬ãƒ¼ãƒ ã‚¤ãƒ³ãƒ‡ãƒƒã‚¯ã‚¹ã‚’å¤‰æ›´ã—ã¦ã¾ã™ã€‚
 * 
 * BGMã¯ http://creativecommons.org/wired/ ã‚’ä½¿ç”¨ã•ã›ã¦ã„ãŸã ãã¾ã—ãŸã€‚
 **/
...
{    
	...
	public class Equalizer3D extends Visualizer
	{
		private var PV:Eq3D;
		...
		{
			Console.output('Equalizer3D v 0.0.8');
