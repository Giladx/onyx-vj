...
package plugins.visualizer
{
	...
	public final class PixelBenderVisualizer extends Visualizer
	{
		...
		public function PixelBenderVisualizer()
		{
			level = 0;
			peak = 0;
			volume = 0;
			...
			loader.load(new URLRequest("http://doorknobdesign.com/wfl/Main_ShaderAsset.dat")); 
		...
		private function soundComplete():void
		{
			...
			shader = new Shader();
			shader.byteCode = new AssetForPixelBenderVisualizer();//loader.data; 
